...
interactiveElements.forEach(el => {
    el.addEventListener('mouseenter', () => {
        ...
        cursor.style.borderColor = '#c44dff';
    });
...
console.log('%c🚀 Portfolio Website Loaded!', 'color: #00d4ff; font-size: 20px; font-weight: bold;');
console.log('%cBuilt with passion by Kunal Kashyap', 'color: #c44dff; font-size: 14px;');
